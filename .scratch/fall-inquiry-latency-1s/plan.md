...
3. As soon as MiMo prompt playback starts, record the real microphone for 2,000 ms and immediately send that WAV to MiMo. Keep this capture window independent from the fall decision's 3,000 ms server-side timeout guard.
