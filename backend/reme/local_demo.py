...
def _process_group_alive(managed: ManagedProcess) -> bool:
    try:
        ...
        # macOS can briefly report EPERM for an already-signalled orphaned
        # process group before the direct child is reaped. Treat it as no
        # longer supervisable here; the direct child is still waited below.
        return False
    return True
