/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fb7a4bf1927b65698f618df268705e5e)
// Runtime types generated with workerd@1.20260801.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173,http://127.0.0.1:4173,http://localhost:4174,http://127.0.0.1:4174,https://reme.maniforld.com,https://monitor.reme.maniforld.com,https://reme-sage.vercel.app";
	BACKEND_PUBLISH_TOKEN: string;
	TURN_KEY_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "BACKEND_PUBLISH_TOKEN" | "TURN_KEY_ID" | "TURN_KEY_API_TOKEN">> {}
}
