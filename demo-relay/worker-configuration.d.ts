/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 15bd41869bd2198d9658e06292762037)
// Runtime types generated with workerd@1.20260801.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173,http://127.0.0.1:4173,http://localhost:4174,http://127.0.0.1:4174,https://reme.maniforld.com,https://reme-sage.vercel.app";
